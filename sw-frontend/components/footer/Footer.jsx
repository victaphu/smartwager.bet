            ...
            <div className="col-12">
              <div className="copyright">
                <div className="copy-area">
                  <p>
                    {" "}
                    Copyright © <Link href="/">SmartWager</Link> | Designed by Steve and Victa for <a href="https://constellation-hackathon.devpost.com/" rel="noreferrer" target="_blank">Chainlink Constellation Hackathon (2023)</a>
